   function [average, variance] = tsp(n,temp)
...
%  is decreased by 1%.
    ...
    % nargin gives the number of arguments of the function
   if (nargin<2) 
     temp = 0.1;   % default: T=0.1
   end
   temps = temp;   % intial temperature 
    
   % the old input vakue now is a constant
   maxsteps = 100;
